...
20. **No bypassing plan_orchestrator.py** — Plan phase must run via orchestrator FSM, not manually. Orchestrator ensures all steps (SCOUTs, adversarial review, SDD approval, QC, plan approval) execute in order.
