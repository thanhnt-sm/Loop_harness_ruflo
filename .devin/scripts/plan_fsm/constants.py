...
STATE_PLAN = "PLAN"
STATE_GAP_SCAN = "GAP_SCAN"
STATE_QC = "QC"
STATE_PLAN_ENHANCE = "PLAN_ENHANCE"
...
ACTION_GAP_SCAN = "gap_scan"
ACTION_RUN_QC = "run_qc"
ACTION_PLAN_ENHANCE = "plan_enhance"
...
STATE_PHASE: dict[str, str] = {
    ...
    STATE_BRAINSTORM: "Brainstorm đa góc nhìn",
    ...
    STATE_GAP_SCAN: "Quét thiếu sót",
    STATE_QC: "Kiểm tra chất lượng plan",
    STATE_PLAN_ENHANCE: "Nâng cấp plan tối đa",
