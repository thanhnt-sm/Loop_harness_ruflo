...
| Personas (3): architect, code_reviewer, git_workflow_master (`.devin/agents/personas/`) | Domain expertise for dispatch (U26: merged database_optimizer, devops_automator, frontend_developer into architect) |
