# Harness Issue Report — 2026-08-23 21:31
...
|---|----------|------|------|-------------|-----|
| 1 | ARCH-006: Missing Hash | `.devin\hooks\pre_tool_common.py` | 0 | Hook pre_tool_common.py not in hash baseline | Regenerate baseline with hook_integrity.py --generate |
| 2 | ARCH-006: Missing Hash | `.devin\hooks\pre_tool_gates_security.py` | 0 | Hook pre_tool_gates_security.py not in hash baseline | Regenerate baseline with hook_integrity.py --generate |
| 3 | ARCH-006: Missing Hash | `.devin\hooks\pre_tool_workspace.py` | 0 | Hook pre_tool_workspace.py not in hash baseline | Regenerate baseline with hook_integrity.py --generate |
