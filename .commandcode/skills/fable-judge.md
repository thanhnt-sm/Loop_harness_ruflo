<!-- POINTER: canonical source HLK/skills/fable-judge.md -->
...
> Composes with `.devin/canon/VERIFICATION_PROTOCOL.md §Verbatim execution gates` — the maker
...
Auditor (`.devin/skills/auditor.md`, `.devin/agents/workers/AUDITOR.md`) runs every 5
