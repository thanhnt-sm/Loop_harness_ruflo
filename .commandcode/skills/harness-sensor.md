<!-- POINTER: canonical source HLK/skills/harness-sensor.md -->
...
> Implements Q3 computational sensors per `.devin/canon/HARNESS_ENGINEERING.md` and CLI gates per `.devin/canon/VERIFICATION_PROTOCOL.md`.
